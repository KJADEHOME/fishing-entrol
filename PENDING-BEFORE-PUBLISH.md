...
| 环节 | 状态 |
|---|---|
| 三家工厂授权 — **口头同意** | ✅ 已获同意（润鼎 / 民盛 / CRONY） |
| 三家工厂授权 — **书面留档** | ❌ **未完成，当前唯一硬门槛** |
| 域名注册 / 企业邮箱 | ❌ 未完成 |
| 部署 | ⛔ 被硬约束锁定，需另行授权 |
...
|---|---|---|---|---|---|
| Weihai CRONY Fishing Tackle | 4 个竿型页全部产品图来源（31 张） | ✅ 已同意 | ❌ **待归档（最高优先）** | 产品图 + 参数表数据的授权 | `authorization-letter-EN.md` |
