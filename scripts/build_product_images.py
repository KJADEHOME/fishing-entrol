...
MAP = {
    "spinning-rod": [
        ("BassPerchRods-01.jpg", "Spinning rod — full rod view — OEM carbon rod manufacturer"),
        ...
        ("BassPerchRods-09.png", "Spinning rod reel seat cap close-up — metal trim and screw cap — OEM carbon rod manufacturer"),
        ("BassPerchRods-06.jpg", "Full cork handle spinning rod — 2.13–2.29 m, 4–20 lb — OEM carbon rod manufacturer"),
        ("BassPerchRods-19.jpg", "Spinning rod — carbon blank with protective wrap — OEM carbon rod manufacturer"),
    ],
    "carp-rod": [
        ("CarpRods-01.jpg", "Carp rod — full rod profile — 2.7–3.6 m 2-piece — OEM carbon rod manufacturer"),
    ...
    "saltwater-rod": [
        ("BoatRods-01.jpg", "Boat rod — full rod profile — 20–200 lb — OEM carbon rod manufacturer"),
        ...
        ("BoatRods-09.jpg", "Inshore boat rod — orange baked finish — OEM carbon rod manufacturer"),
    ...
    "rock-surf-rod": [
        ("SurfRods-01.jpg", "Surf casting rod — 4.2 m / 4.5 m — OEM carbon rod manufacturer"),
    ...
    "about-factory": [
        ("cand_59.jpg", "Rod manufacturing facility in Weihai, Shandong — OEM carbon rod manufacturer", MS_URL + "/article.html"),
    ],
}
